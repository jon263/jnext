...
BEGIN {
    ...
    M["symbol_table_test"]             = "Compiler Symbols"
    M["source_map_test"]               = "Source Maps"
    M["page_aware_debug_test"]         = "Page-aware Debug Core"
    M["debugger_source_step_test"]     = "Source Debugging"
    M["debugger_page_watch_test"]      = "Page-pinned Watches"
